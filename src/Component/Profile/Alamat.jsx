...
const Alamat = (props) => {
  const [prov, setProv] = useState(props.dataUser.provinsi);
  const [idKota, setIdKota] = useState(props.dataUser.id_kabupaten);
  const [dataKota, setDataKota] = useState([]);
  const [kabkota, setKabKota] = useState(props.dataUser.kabupaten);
  const [alamat, setAlamat] = useState(props.dataUser.alamat);
    ...
    <>
      <Form onSubmit={handleSubmit}>
        <Row>
          <Col lg={12}>
            <Form.Group className="mb-1">
              ...
              <Form.Select defaultValue={props.dataUser.provinsi} onChange={(e) => handleChange(e)}>
          ...
          <Col lg={12}>
            {dataKota.length > 0 ? (
              <Form.Group className="mb-1">
                ...
                <Form.Select defaultValue={`${props.dataUser.kabupaten}-${props.dataUser.id_kabupaten}`} onChange={(e) => handleChangeKota(e)}>
        ...
        <Form.Group className="mb-1" controlId="exampleForm.ControlTextarea1">
          ...
          <Form.Control value={alamat ? alamat : ''} onChange={(e) => setAlamat(e.target.value)} as="textarea" placeholder="Alamat detail" rows={3} />
        </Form.Group>
